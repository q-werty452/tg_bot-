...
class Session:
    ...
    provider: str
    # Диалоговый режим по умолчанию: житель пишет с телефона и ждёт ответа
    # секунды, а не полторы минуты. Развёрнутый включается командой /mode,
    # когда человеку правда нужен разбор с перечнем документов.
    mode: Mode = Mode.CHAT
